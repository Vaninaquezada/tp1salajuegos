...
export class ErrorService {
  getError(errorCode: any) {
    const AuthFirebaseErrors = {
      ...
      'auth/invalid-email':
        '	La dirección de correo electrónico ingresada no es valida.',
      ...
      'auth/invalid-hash-rounds':
        'Las rondas de hash deben ser un número válido.',
      ...
      'auth/user-not-found':
        'El correo electrónico proporcionado no corresponde a un usuario activo',
    } as FirebaseErrors;
